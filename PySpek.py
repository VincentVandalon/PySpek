...
class PySpek(object):
    ...
    def read_cal(self,offset):
       ...
       if self.aqTime == 0:
          self.aqTime=1
          print 'Time was not read correctly from SPE file, counts/s is not set correctly'
    ...
    def convertPixels(self,pixels):
       ...
       for p in pixels:
          ...
          wls.append(self.polynom_coeff[0]+self.polynom_coeff[1]*(p+1)+self.polynom_coeff[2]*(p+1)**2)
       return N.array(wls)
    ...
    def load_img(self,startFrame,endFrame):
